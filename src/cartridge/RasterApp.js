...
export default class Render {
  ...
  createGUI = () => {
    ...
    folderRender.add(this.options, 'baseRadius', 0, 50).step(0.1)
      .onFinishChange((value) => {
        this.baseRadius = value;
        this.preparePoints();
      });
    folderRender.add(this.options, 'multiplier', 0, 100).step(0.1)
      .onFinishChange((value) => {
  ...
  calculateRadius = ( x, y, color) => {
    const radius = ( this.baseRadius * ( color / this.multiplier) );
